local tentwelvesixteen = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO	
	...
	["Great Paraselene Sage"] = {
		...
		["Effect"] = {
			Name = "Lunar Rays",
			Description = "Whenever you summon another fighter, lose all of your yellow icons, destroy that fighter and deal 300 damage to a target fighter. Abilities don't trigger when this card enters play.",
			["Type"] = "OnAllySummon",
