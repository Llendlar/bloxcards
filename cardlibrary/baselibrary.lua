local base = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Demonic Godbeast"] = {
		...
		["Effect"] = {
			Name = "Revival",
			Description = "Can't attack. Immune to all stat-changing effects. At the end of the turn, destroy this fighter. This card does not activate any effects upon dying.",
			["Type"] = "OnEnd",
			["Power"] = "Heal",
			Target = "Self",
			Increase = -999999,
